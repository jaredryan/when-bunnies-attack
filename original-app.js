...
function finalEncounter(enemyPlayer) {
  ...
  sleep.msleep(2000);
  console.log(
    'I will see that her dream continues and annihilate all who stand in my way!"',
  );
  sleep.msleep(2500);
...
function forcedFight(enemyInfo, player) {
  ...
  while (true) {
    // Player's turn
    var fightChoice = readlineSync.keyInSelect(
      forcedFightOptions,
      "Your turn: ",
    );
    switch (fightChoice) {
...
var checkCurrentStatus = new Event(
...
var leaveArea = new Event("Leave the area", leaveTheArea, "", false, {});
...
var swRoom0 = new Area("SW Room", [], 0, function () {
  ...
  sleep.msleep(2000);
  console.log(
    '"I must have hit my head. Can"' +
      "'t believe I almost forgot. It's...\"\n",
  );
  sleep.msleep(2000);
  ...
  console.log(
    "\n\"...I'm " +
      player.name +
      ". My head hurts. I wonder if I actually forgot anything.",
  );
  sleep.msleep(2000);
  console.log("Like...for example, where I'm at. What is this place?\"\n");
  sleep.msleep(2000);
  console.log(
    "As you look around, you notice that you are in a simple room. The walls",
  );
  sleep.msleep(2000);
  console.log(
    "are a dull grey; the bed you are on is simple: wood, white sheets, and white",
  );
  sleep.msleep(2000);
  console.log(
    "blankets. There's a nightstand by the bed. You don't sense any danger, but",
  );
  sleep.msleep(2000);
...
var seRoom3 = new Area("SE Room", [0, 4], 3, function () {
  ...
  var index = readlineSync.keyInSelect(
    [
      "You: \"Can I talk to you about what's going on? I'm confused.\"",
      'You: "I want to keep looking around, if that\'s okay."',
    ],
...
var escape7 = new Area("Forest", [6], 7, function () {
  ...
  sleep.msleep(2000);
  console.log(
    "Examining the outside of the building, it looks like a small fortress.",
  );
  sleep.msleep(2000);
  console.log(
    "Looking for a way out of the forest, you notice that the forest is very dense.",
  );
  sleep.msleep(2000);
...
var forestExit8 = new Area("Forest Exit", [7], 8, function () {
  ...
  sleep.msleep(2000);
  console.log(
    "you see another bunny and some sort of machine. No one else is around.",
  );
  sleep.msleep(2000);
  console.log(
    "The bunny has already spotted you, so there's no running away now.",
  );
  sleep.msleep(2000);
});
