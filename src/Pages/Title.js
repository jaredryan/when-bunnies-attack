const Title = (props) => (
    <div className="titleContainer">
        ...
        <p>
            ...
            originally one single JavaScript file ran by Node in the terminal,
        ...
        <p>
            ...
            got the time to spare...or, you know, just leave this open in some
            tab till you can come back to it. Good luck!
        </p>
