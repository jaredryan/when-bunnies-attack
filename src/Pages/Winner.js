const Winner = (props) => (
    <div className="winnerContainer">
        <h1>When Bunnies <span className="emphasis">Lose</span></h1>
        <h2>Nice job, you escaped!</h2>
        <p>
            Hats off to you, my friend. Not only did you escape bunny experiments and
            the horrors of a vegetarian diet, but you managed to play through a novice
            developer's game! That's a 3-fold escape: a hat trick, if you will.
        </p>
        <p>
            ...
            share with a friend or click that big ol' button below to go say hi to your
            little friends.
        </p>
