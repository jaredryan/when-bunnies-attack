...
export const swRoom0 = new Area("SW Room", [], 0, function () {
...
export const wRoom1 = new Area("W Room", [0, 4], 1, function () {
...
export const lab2 = new Area("Lab", [1], 2, function () {
...
export const seRoom3 = new Area("SE Room", [0, 4], 3, function () {
...
export const eRoom4 = new Area("E Room", [1, 3, 6], 4, function () {
...
export const treasury5 = new Area("Treasury", [4], 5, function () {
...
export const neRoom6 = new Area("NE Room", [4, 7], 6, function () {
...
export const escape7 = new Area("Forest", [6], 7, function () {
...
export const forestExit8 = new Area("Forest Exit", [7], 8, function () {
